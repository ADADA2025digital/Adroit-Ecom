...
const Cookies = () => {
  ...
  return (
    <div
      className={`card cookie-card bg-white d-flex flex-column align-items-center justify-content-center rounded-0 p-4 gap-3 position-fixed
      ${visible && !hiding ? "slide-in" : ""} ${hiding ? "slide-out" : ""}`}
    >
      <div className="card-header bg-transparent border-0 w-100 d-flex justify-content-end position-absolute top-0 start-0 p-2">
        <button
          type="button"
          className="btn-close"
      ...
      <p className="dark-text m-0 fw-bold heading">We use cookies.</p>
      <p className="text-muted text-center small m-0">
        Adroit uses cookies to improve your shopping experience. By continuing,
        you agree to our{" "}
        <a href="/privacypolicy" className="dark-text">
          Privacy Policy
        </a>
        .
      </p>
